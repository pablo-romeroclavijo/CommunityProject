...
async function loadProfile() {
	...
	if (localStorage.token) {
		...
		if (data.isAdmin !== true) {
			...
			const instructions = [
				"Instruction 1: Check the table for the item you with to donate and add it to your list.",
				"Instruction 2: This will add the item to the donation table below. Once you are happy with your donation hit submit.",
				"Instruction 3: You will then recieve a QR code for drop off along with a drop off code as an alternative.",
			];
