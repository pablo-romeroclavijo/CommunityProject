...
class User {
    ...
    static async create(data) {
        ...
        const response = await db.query("INSERT INTO user_account (username, postcode, email, password) VALUES ($1, $2, $3, $4) RETURNING user_id;",
            [username, postcode, email, password]);
