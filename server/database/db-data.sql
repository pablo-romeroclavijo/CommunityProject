...
('Milk (refrigerated)',1,1,1,'Litre','Requires refrigeration.', 'Dairy', 'Milk'),
('Soya Milk (unsweetened)',9,5,15,'Litre','Requires refrigeration.', 'Dairy', 'Milk'),
('Milk (long-life)',9,5,15,'Litre','Store in a cool dry place. Once opened, keep refrigerated and treat as fresh milk.', 'Dairy', 'Milk'),
('Greek Yogurt',1,5,2,'Unit','Requires refrigeration.', 'Dairy', 'Yoghurts'),
...
('Noodles',8,2,0,'340 grams','Fine egg noodles. Store in a cool dry place.', 'Dried Pasta', 'Noodles, Rice & Grains'),
('Rice',8,2,0,'1 kg','Store in a cool dry place.', 'Dried Pasta', 'Noodles, Rice & Grains'),
('Cous cous (whole wheat)',8,3,12,'500 grams','Store in a cool dry place. 14 servings.', 'Dried Pasta', 'Noodles, Rice & Grains'),
('Lentil Bag',8,1,0,'1 kg','Dried red split lentils. Gluten-free. Store in a cool dry place.', 'Dried Pasta', 'Noodles, Rice & Grains'),
('Toothpaste',5,1,10,'125 ml','Not for use of children under 7 years old. Contains: Glycerin, Aqua, Hydrated Silica. Contains: Sodium Fluoride Total Fluoride content: 1450 ppm', 'Hygiene', 'Dental'),
